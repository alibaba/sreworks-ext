...
python main.py --anormly_ratio 0.5 --num_epochs 3   --batch_size 1  --mode train --dataset UCR  --data_path UCR   --input_c 1 --output 1 --index 3 --win_size 200
python main.py --anormly_ratio 0.5 --num_epochs 10   --batch_size 1    --mode test    --dataset UCR   --data_path UCR     --input_c 1   --output 1  --index 3 --win_size 200