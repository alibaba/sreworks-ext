...
#resp = ai.run("47.94.18.251 这是hfds集群的一台master机器，可以直连。帮忙看一下这个hdfs集群有哪些namenode，以及每台namenode机器当前load是多少", llm=OpenAI(temperature=0), tools=[HDFSCluster], verbose=True)
print("=== resp ===")
print(resp)
